...
class ApiService {
  static Future<bool> uploadDocketImage(File imageFile, String fileName) async {
    print('DEBUG: ApiService.uploadDocketImage called with file: ${imageFile.path}');
    ...
    print('DEBUG: About to send HTTP request to $uri with fields: ${request.fields}');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('DEBUG: Upload failed with status ${response.statusCode}: $responseBody');
        developer.log(
